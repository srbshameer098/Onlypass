        ...
        children: [
            ...
            children: [
              CarouselSlider.builder(
                itemBuilder: (BuildContext context, int itemIndex,
                        int pageViewIndex) =>
                    widget.fecilityModel.images![itemIndex].length > itemIndex
                        ? SizedBox(
                            width: 393.w,
                            height: 240.h,
                            child: Image.network(
                              widget.fecilityModel.images![itemIndex]
                                  .toString(),
                              fit: BoxFit.fill,
                            ),
                          )
          ...
          Padding(
            ...
            child:
              ...
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    SizedBox(
                      width: 200.w,
                      child: Text(widget.fecilityModel.address.toString(),
                          style: TextStyle(
                              color: Theme.of(context).colorScheme.onSecondary,
                              fontSize: 14.sp,
                              fontWeight: FontWeight.w500,
                                      ...
                                      children: <Widget>[
                                        ...
                                        SizedBox(
                                          ...
                                          child: ListView.builder(
                                              itemCount: widget.fecilityModel
                                                  .facilityTiming!.length,
                                              itemBuilder:
                ...
                child: Row(
                  children: [
                    ...
                    Container(
                      ...
                      decoration: BoxDecoration(
                        border:
                            Border.all(width: 1.w, color: Colors.grey.shade900),
                        color: const Color(0xFFFFFFFF),
                      ),
                      child: Padding(
                        padding: EdgeInsets.symmetric(horizontal: 6.w),
              ...
              SizedBox(
                height: (widget.fecilityModel.amenities!.length / 1.2) * 50.h,
                              ...
                              Container(
                                ...
                                child: Padding(
                                  padding: EdgeInsets.only(
                                      ...
                                      bottom: 2.h),
                                  child: Image.network(
                                    widget.fecilityModel.amenities![index]
                                        .iconUrl!
                                        .toString(),
                                    width: 14.w,
                                    height: 14.h,
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: SizedBox(
                              width: 351,
                              child: Text(
                                'Solid equipment and friendly staff, but the locker rooms could use a refresh. Overall, a great workout experience!',
                                style: TextStyle(
                                  color:
                                      Theme.of(context).colorScheme.onSecondary,
                                  fontFamily: 'Montserrat',
